...
\item We repeat the above experiment but with a higher value of $\epsilon=0.10$. We can qualitatively note that our loopy BP algorithm did not converge as well with this amount of noise. See Figure for reference.
